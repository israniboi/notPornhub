...
var comments = [
  ...
  {name: "So beutiful! ", type: "positive"},
  {name: "I've been jacking off since the beginning, please reply <3", type: "positive"},
  {name: "One of the best bodies out there", type: "positive"},
  {name: "I cummed throughout the entire video", type: "positive"},
  {name: "That body was so beautiful :')", type: "positive"},
  {name: "check out my channel Thomas Loizel on all 420 porn sights", type: "positive"},
  {name: "Can I please get a shoutout?", type: "positive"},
  {name: "My screen went all white for some reason ", type: "positive"},
  {name: "I'm an aspiring pornstar, and my new videos is out now!! Please check out my channel", type: "positive"},
  {name: "U know this rocks when people come back 2 years later!", type: "positive"},
  {name: "69", type: "positive"},
  {name: "favourited, liked, subscribed", type: "positive"},
  {name: "420", type: "positive"},
  {name: "LOVE THIS", type: "positive"},
  {name: "I remove adblock for this site only", type: "positive"},
  ...
  {name: "you remind me of Lana Rohdes ", type: "positive"},
  {name: "Don't ever quit pornhub", type: "positive"},
  {name: "Can I come over BBG ", type: "positive"},
  {name: "editing is on point", type: "positive"},
  {name: " toooo hot", type: "positive"},
  ...
  {name: "Are you a hot dog stand, because you make my hot dog stand", type: "positive"},
  ...
  {name: "Please quit pornhub", type: "negative"},
  ...
  {name: "I miss the old pornhub", type: "negative"},
...
var commentBox = [{comment:"👋 Welcome to not Pornhub ", source:"story"},
                  {comment:"This is a game of patience, optimisation & problem-solving.", source:"story"},
                  {comment:"You're a young aspiring Pornstar, with high hopes and dreams.", source:"story"},
...
var ideaProjects = [
  ...
  ["Jack off real fast","Generate 70 ideas","ideasQtTotal>=70","napAppear()","Surely Tim Ferris does this <span class='boldRed'>[Power Nap activated]</span>","story","You now fall asleep as soon as you hit 0 energy."],
  ...
  ["Take porno classes","Generate 300 ideas & Pay $8k","ideasQtTotal>=300 && cashAmount >=8000","upgradeEnergyBatch(10);cashAmount-=8000","Helps you think clearly but wow that's expensive <span class='boldRed'>[-10 Energy Cost & -$8k]</span>","0",""],
  ["Buy a sex toy","Generate 400 ideas & Reach 150M views & Pay $15k","views>=150000000 && ideasQtTotal>=400 && cashAmount >=15000","upgradeCreativity(5);ideaRangeMax(rangeIdea);cashAmount-=15000","They're the real OGs of YouTube <span class='boldRed'>[+5 Creativity & -$15k]</span>","0","0"],
  ["Buy an alarm cock","Generate 500 ideas & Pay $12","ideasQtTotal>=500 && cashAmount >=12","alarmAppear();cashAmount-=12","Because Apple's last update scrapped the feature <span class='boldRed'>[Alarm Clock activated]</span>","story","You now wake-up as soon as your energy is full."],
  ...
  ["Suck it every morning","Generate 800 ideas","ideasQtTotal>=800","upgradeEnergyBatch(5)","Clear mind leads to great content - is a Buddhist saying <span class='boldRed'>[-5 Energy Cost]</span>","0",""],
  ...
  ["Start onlyfans","Reach 7M subscribers & Pay $50k","subscribers>=7000000 && cashAmount>=50000","upgradeCreativity(20);ideaRangeMax(rangeIdea);cashAmount-=50000","About to reach the Ender Dragon... <span class='boldRed'>[+20 Creativity & -$50k]</span>","0","0"],
  ["Start a live club","Reach 10M subscribers & 5B views","subscribers>=10000000 && views>=5000000000","upgradeCreativity(40);ideaRangeMax(rangeIdea)","Daily routine and all <span class='boldRed'>[+40 Creativity]</span>","0","0"],
...
var uploadProjects = [
  ...
  ["Figure out how to use hotspot","Upload 15 videos & Pay $100","videosUploaded>=15 && cashAmount>=100","upgradeUploadSpeed(7);cashAmount-=100","Parents weren't please with the phone bill <span class='boldRed'>[+100kB/s Upload Speed & -$100]</span>","0","0"],
  ["Buy a sex toy","Upload 20 videos & Pay $500","videosUploaded>=20 && cashAmount>=500","upgradeUploadSpeed(8);cashAmount-=500","Old school but efficient <span class='boldRed'>[+100kB/s Upload Speed & -$500]</span>","0","0"],
  ["Convince parents WiFi isn't an NSA spying device","Upload 50 videos & Pay $2k","videosUploaded>=50 && cashAmount>=2000","upgradeUploadSpeed(9);cashAmount-=2000","Or is it..? <span class='boldRed'>[+300kB/s Upload Speed & -$2k]</span>","0","0"],
  ["Fail health class","Upload 75 videos","videosUploaded>=75","projectedAverageAppear()","But you can still calculate an average come on <span class='boldRed'>[Projected average based on videos ready to upload]</span>","0","0"],
...
var subProjects = [
  ...
  ["Shoutout from LorrAINIAC","Reach 1M subscribers","subscribers>=1000000","LDRF(0.2)","Doing your mom =3 <span class='boldRed'>[+0.2 Popularity]</span>","story","channelReplace is about to snowball the next 99M subs!"],
  ...
  ["Accomplish every Pornhub challenge","Reach 2M subscribers","subscribers>=2000000","views+=10000000","Chubby bunny <span class='boldRed'>[+10M Views]</span>","0","0"],
  ...
  ["Participate in Pornhub Rewind","Reach 5M subscribers","subscribers>=5000000","LDRF(-0.8)","They can't seem to get it right <span class='boldRed'>[-0.8 Popularity]</span>","0","0"],
